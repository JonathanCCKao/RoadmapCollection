...
class TestConfluenceRoadmap(unittest.TestCase):
    ...
    def test_generate_plantuml(self):
        ...
        self.assertIn("2026-01-01 to 2026-12-31 are colored in #F8F9F9", gantt)
        self.assertIn("[<color:#1F4E79><b>C0</b></color>] as [IES-3100_c0] starts 2026-03-01 and ends 2026-05-15", gantt)
